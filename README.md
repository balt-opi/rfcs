...
OPI projects uses the RFC (request for comments) process for
collaborating on substantial changes to OPI initiatives. RFCs enable contributors to
...
* Changes to how projects are packaged, distributed, or configured.
...
feel free to [ask in `OPI Data Analytics`](https://teams.microsoft.com/l/chat/19:212a66c6964d446987761cdd95cac046@thread.v2/conversations?context=%7B%22contextType%22%3A%22chat%22%7D)!
...
1. Write your proposal in `000-my-proposal/proposal.md`.
    ...
    * Consult the [OPI design principles](DESIGN_PRINCIPLES.md) to guide
      your design.
...
1. The RFC will be assigned to a member of the OPI dev team. The
...
members of the opi dev team. Feedback from diverse perspectives is necessary for
determining a proposal's efficacy, impact, and priority. Reviewing RFCs is also
great practice for joining the opi dev team someday!
...
Once the review status stabilizes and clarity has been reached, the opi dev team
...
When an RFC is merged the opi dev team assignee is responsible for opening an
issue on the respective project directory to
...
The opi dev team is responsible for determining the
...
From there, the implementation process falls under the normal OPI
development process.
